...
class TimerEditScreenTest {
    ...
    fun servicePickReloadKeepsTypedTitleDescriptionAndToggles() {
        ...
        composeRule.onNodeWithContentDescription("Title")
            .performTextReplacement("Keep This Title")
        composeRule.onNodeWithContentDescription("Description")
            .performTextReplacement("Keep This Description")
        composeRule.onNodeWithText("Enabled").performClick()
        ...
        composeRule.onNodeWithText("Keep This Title").assertIsDisplayed()
        composeRule.onNodeWithText("Keep This Description").assertIsDisplayed()
