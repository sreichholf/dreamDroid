...
| okhttp-enigma2 | [#348](https://github.com/sreichholf/dreamDroid/pull/348) | open | SOTA: Enigma2 `SimpleHttpClient` → Kotlin + OkHttp 4.12 (align with Picasso); drop `HttpURLConnection` on box XML path. |
...
Wave 3 (operator choice): convert remaining **non-Compose phone UIs** to Compose + Kotlin, **one PR per screen**. Checklist in Appendix G. **Wave 3 phone screens complete on `main` through #206** (plus CI #204). Phone Phase 2.7 (Fragment shells → Kotlin Compose destinations) **2.7b–i merged** ([#306](https://github.com/sreichholf/dreamDroid/pull/306)–[#315](https://github.com/sreichholf/dreamDroid/pull/315)). **#316–#343 merged**. **#344–#346 merged** (dialogs 2.1g-ii-d…f). **This PR:** OkHttp Enigma2 (`SimpleHttpClient`). **Next:** VideoOverlay Kotlin / TV MainActivity Kotlin / Phase **4**.
...
- Phone NavHost Device Info through Hub are **Kotlin Compose destinations**; Phase **2.7b–i** **merged** ([#306](https://github.com/sreichholf/dreamDroid/pull/306)–[#315](https://github.com/sreichholf/dreamDroid/pull/315); decision [#304](https://github.com/sreichholf/dreamDroid/pull/304)). **#316–#343 merged**. **#344–#346 merged** (dialogs 2.1g-ii-d…f). **This PR:** OkHttp Enigma2 (`SimpleHttpClient`). **Next:** VideoOverlay Kotlin / TV MainActivity Kotlin / Phase **4**.
...
- Phase 3.1c-iv full Compose TV hub (**option C**) **merged** through **iv-g** [#336](https://github.com/sreichholf/dreamDroid/pull/336)–[#341](https://github.com/sreichholf/dreamDroid/pull/341). **#343 merged**. **#344–#346 merged** (dialogs 2.1g-ii-d…f). **This PR:** OkHttp Enigma2 (`SimpleHttpClient`). **Next:** VideoOverlay Kotlin / TV MainActivity Kotlin / Phase **4**.
...
- **#316–#343 merged**. **#344–#346 merged** (dialogs 2.1g-ii-d…f). **This PR:** OkHttp Enigma2 (`SimpleHttpClient`). **Next:** VideoOverlay Kotlin / TV MainActivity Kotlin / Phase **4**.
...
- Enigma2 HTTP **this PR:** `SimpleHttpClient` is Kotlin + OkHttp 4.12 (Picasso-aligned); typed `EnigmaClient` unchanged. `asynctask/*` retired.
...
| Enigma2 HTTP | `HttpURLConnection` `SimpleHttpClient` | OkHttp (aligned with Picasso stack) | **this PR** — Kotlin `SimpleHttpClient` + OkHttp; unit tests for URL builders |
...
**Safe next after Phase 0 / 3.1c focus dive landed:** Phase 3 cards/prefs (done). Broader Appendix H phone NavHost/widgets/VLC/state **merged**. Phone Phase **2.7b–h** destinations **merged**; **2.7i merged** [#315](https://github.com/sreichholf/dreamDroid/pull/315). **#316–#343 merged**. **This PR:** OkHttp Enigma2 (`SimpleHttpClient`). **Next:** VideoOverlay Kotlin / TV MainActivity Kotlin / Phase **4**.
...
**Phase 2.7i merged** [#315](https://github.com/sreichholf/dreamDroid/pull/315). **#316–#347 merged**. **This PR:** OkHttp Enigma2 (`SimpleHttpClient`). **Next:** VideoOverlay Kotlin / TV MainActivity Kotlin / Phase **4**.
...
- Phase **2.7i** chassis cleanup **merged** [#315](https://github.com/sreichholf/dreamDroid/pull/315). Keepers reopen **merged** [#335](https://github.com/sreichholf/dreamDroid/pull/335). **3.1c-iv-b–g** **merged** [#336](https://github.com/sreichholf/dreamDroid/pull/336)–[#341](https://github.com/sreichholf/dreamDroid/pull/341). **#343 merged**. **#344–#346 merged** (dialogs 2.1g-ii-d…f). **This PR:** OkHttp Enigma2 (`SimpleHttpClient`). **Next:** VideoOverlay Kotlin / TV MainActivity Kotlin / Phase **4**.
