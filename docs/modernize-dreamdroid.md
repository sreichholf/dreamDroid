...
| tv-compose-hub-iv-c | | open | Phase 3.1c-iv-c: Compose TV hub chrome — TV Material `NavigationDrawer` side headers + row list focus model; settings row Reload / Preferences / Profile. Leanback remains default behind debug flag. No service/movie rows yet (iv-d/e). |
