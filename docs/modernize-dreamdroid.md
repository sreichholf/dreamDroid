...
| tv-compose-hub-iv-c | [#337](https://github.com/sreichholf/dreamDroid/pull/337) | open | Phase 3.1c-iv-c: Compose TV hub chrome — TV Material `NavigationDrawer` side headers + row list focus model; settings row Reload / Preferences / Profile. Leanback remains default behind debug flag. No service/movie rows yet (iv-d/e). |
...
Wave 3 (operator choice): convert remaining **non-Compose phone UIs** to Compose + Kotlin, **one PR per screen**. Checklist in Appendix G. **Wave 3 phone screens complete on `main` through #206** (plus CI #204). Phone Phase 2.7 (Fragment shells → Kotlin Compose destinations) **2.7b–i merged** ([#306](https://github.com/sreichholf/dreamDroid/pull/306)–[#315](https://github.com/sreichholf/dreamDroid/pull/315)). **#316–#336 merged**. **This PR:** Phase **3.1c-iv-c** (Compose TV hub chrome: `NavigationDrawer` headers + settings row). **Next:** **3.1c-iv-d** service/now-next rows (dialogs **2.1g-ii** remains parallel SOTA backlog).
...
- Phone NavHost Device Info through Hub are **Kotlin Compose destinations**; Phase **2.7b–i** **merged** ([#306](https://github.com/sreichholf/dreamDroid/pull/306)–[#315](https://github.com/sreichholf/dreamDroid/pull/315); decision [#304](https://github.com/sreichholf/dreamDroid/pull/304)). **#316–#336 merged**. **This PR:** Phase **3.1c-iv-c** (Compose TV hub chrome: `NavigationDrawer` headers + settings row). **Next:** **3.1c-iv-d** service/now-next rows (dialogs **2.1g-ii** remains parallel SOTA backlog).
...
- Phase 3.1c-iv full Compose TV hub (**option C**) scheduled **merged** [#308](https://github.com/sreichholf/dreamDroid/pull/308); **3.1c-iv-b** **merged** [#336](https://github.com/sreichholf/dreamDroid/pull/336). **This PR:** **3.1c-iv-c** hub chrome. Default hub remains Leanback until flag on / iv-f.
...
- **#316–#336 merged**. **This PR:** Phase **3.1c-iv-c** — Compose TV hub chrome (`NavigationDrawer` side headers + settings Reload/Preferences/Profile). Leanback default behind debug flag. Former keepers remain **SOTA backlog** (dialogs **2.1g-ii**, Glance, OkHttp Enigma2, VideoOverlay Kotlin) in parallel with hub Compose.
...
Operator intent: **migrate everything** (phone leftovers + Leanback → Compose TV), then operator usertests, then bugfix pass. Do **one PR at a time**. Phase 3 hybrid Leanback path is on `main`; **full Compose hub (option C / 3.1c-iv)** is in progress — **this PR is 3.1c-iv-c**.
...
**Safe next after Phase 0 / 3.1c focus dive landed:** Phase 3 cards/prefs (done). Broader Appendix H phone NavHost/widgets/VLC/state **merged**. Phone Phase **2.7b–h** destinations **merged**; **2.7i merged** [#315](https://github.com/sreichholf/dreamDroid/pull/315). **#316–#336 merged**. **This PR:** Phase **3.1c-iv-c** (Compose TV hub chrome). **Next:** **3.1c-iv-d** service/now-next rows (dialogs **2.1g-ii** parallel).
...
| 3.1c-iv-c | Compose hub chrome: side headers + row list focus model; settings row actions (Reload/Preferences/Profile) | **this PR** — TV Material `NavigationDrawer`; Leanback behind debug flag |
...
**Phase 2.7i merged** [#315](https://github.com/sreichholf/dreamDroid/pull/315). **#316–#336 merged**. **This PR:** Phase **3.1c-iv-c** (Compose TV hub chrome). **Next:** **3.1c-iv-d** service/now-next rows (dialogs **2.1g-ii** parallel).
...
| 3.1c | Browse hub → TV Compose | Focus dive **merged** [#238](https://github.com/sreichholf/dreamDroid/pull/238). Cards **merged** [#239](https://github.com/sreichholf/dreamDroid/pull/239)/[#240](https://github.com/sreichholf/dreamDroid/pull/240). Shell **B** **merged** [#241](https://github.com/sreichholf/dreamDroid/pull/241). Option C scheduled **merged** [#308](https://github.com/sreichholf/dreamDroid/pull/308). **3.1c-iv-b** **merged** [#336](https://github.com/sreichholf/dreamDroid/pull/336). **This PR:** **3.1c-iv-c** hub chrome. |
...
- Phase **2.7i** chassis cleanup **merged** [#315](https://github.com/sreichholf/dreamDroid/pull/315). Keepers reopen **merged** [#335](https://github.com/sreichholf/dreamDroid/pull/335). **3.1c-iv-b** **merged** [#336](https://github.com/sreichholf/dreamDroid/pull/336). **This PR:** **3.1c-iv-c**; next **3.1c-iv-d** (dialogs **2.1g-ii** remains parallel SOTA backlog).
