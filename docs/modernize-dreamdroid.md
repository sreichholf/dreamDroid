...
| near-zero-java-helpers | — | open | Near-zero Java residue: drop orphan `Signal` + unused DeviceInfo handler/SAX/hash keys + dead menus; Base64 → `android.util.Base64`. Keep dialogs / VideoOverlay / Leanback / RemoteViews / HttpURLConnection. |
