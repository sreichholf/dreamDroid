...
| dialogs-2-1g-ii-e | | open | Phase 2.1g-ii-e: Multi/simple choice + indeterminate progress → Compose; delete Java FM helpers. |
...
Wave 3 (operator choice): convert remaining **non-Compose phone UIs** to Compose + Kotlin, **one PR per screen**. Checklist in Appendix G. **Wave 3 phone screens complete on `main` through #206** (plus CI #204). Phone Phase 2.7 (Fragment shells → Kotlin Compose destinations) **2.7b–i merged** ([#306](https://github.com/sreichholf/dreamDroid/pull/306)–[#315](https://github.com/sreichholf/dreamDroid/pull/315)). **#316–#343 merged**. **#344 open** (2.1g-ii-d sheets). **This PR:** Phase **2.1g-ii-e** (multi/simple choice + indeterminate progress → Compose). **Next:** **2.1g-ii-f** / Phase **4** operator usertests.
...
- Phone NavHost Device Info through Hub are **Kotlin Compose destinations**; Phase **2.7b–i** **merged** ([#306](https://github.com/sreichholf/dreamDroid/pull/306)–[#315](https://github.com/sreichholf/dreamDroid/pull/315); decision [#304](https://github.com/sreichholf/dreamDroid/pull/304)). **#316–#343 merged**. **#344 open** (2.1g-ii-d sheets). **This PR:** Phase **2.1g-ii-e** (multi/simple choice + indeterminate progress → Compose). **Next:** **2.1g-ii-f** / Phase **4** operator usertests.
...
- **#316–#343 merged**. **#344 open** (2.1g-ii-d). **This PR:** Phase **2.1g-ii-e** — Multi/simple choice + indeterminate progress as Compose M3 dialogs (delete Java FM helpers). Remaining **2.1g-ii-f**; Glance / OkHttp Enigma2 / VideoOverlay Kotlin still SOTA backlog. Phase **4** operator box smoke remains.
...
Operator intent: **migrate everything** (phone leftovers + Leanback → Compose TV), then operator usertests, then bugfix pass. Do **one PR at a time**. Phase 3 hybrid Leanback path is on `main`; **full Compose hub (option C / 3.1c-iv)** code path is on `main` through **iv-f**; **3.1c-iv complete through iv-g**; **this PR is 2.1g-ii-e** (choice/progress Compose dialogs).
...
**Safe next after Phase 0 / 3.1c focus dive landed:** Phase 3 cards/prefs (done). Broader Appendix H phone NavHost/widgets/VLC/state **merged**. Phone Phase **2.7b–h** destinations **merged**; **2.7i merged** [#315](https://github.com/sreichholf/dreamDroid/pull/315). **#316–#343 merged**. **#344 open**. **This PR:** Phase **2.1g-ii-e** (choice/progress Compose). **Next:** **2.1g-ii-f** / Phase **4** operator usertests.
...
**Phase 2.7i merged** [#315](https://github.com/sreichholf/dreamDroid/pull/315). **#316–#343 merged**. **#344 open**. **This PR:** Phase **2.1g-ii-e** (choice/progress Compose). **Next:** **2.1g-ii-f** / Phase **4** operator usertests.
...
| Power / Send message / Sleep timer / Changelog (Nav `dialog`) | M3 `AlertDialog`s on `PhoneNavRoutes.POWER` / `SEND_MESSAGE` / `SLEEP_TIMER` / `CHANGELOG` (`ui/dialogs/DrawerModals.kt`) | Drawer + `MainActivity.showChangeLog` — **2.1g-ii-c** |
| Send message / Power / Sleep timer / Changelog (Nav `dialog`) | M3 `AlertDialog` via `DrawerModals.kt` | Drawer + changelog — **2.1g-ii-c** |
...
| 2.1g-ii-e | Multi/simple choice + indeterminate progress → Compose; delete Java FM helpers | **this PR** — `ChoiceDialogs.kt`; hosts in hub movies / timer edit / profiles / video overlay; `ChoiceDialogsHostTest` |
...
- Phase **2.7i** chassis cleanup **merged** [#315](https://github.com/sreichholf/dreamDroid/pull/315). Keepers reopen **merged** [#335](https://github.com/sreichholf/dreamDroid/pull/335). **3.1c-iv-b–g** **merged** [#336](https://github.com/sreichholf/dreamDroid/pull/336)–[#341](https://github.com/sreichholf/dreamDroid/pull/341). **#343 merged**. **#344 open**. **This PR:** **2.1g-ii-e** choice/progress Compose; next **2.1g-ii-f** / Phase **4**.
