...
| vlc-kotlin-wrapper | (this PR) | open | Phase 2.5e: thin Kotlin `VLCInstance`/`VLCPlayer`; keep existing overlay Compose smoke test. Keep OkHttp 3.14.9. |
...
- Phase 2.5e thin Kotlin VLC wrapper **this PR**.
...
| 2.5e | Optional: thin Kotlin VLC wrapper + instrumented overlay smoke | **This PR:** Kotlin `VLCInstance`/`VLCPlayer`; existing `VideoOverlayScreenTest` remains the overlay smoke. No codec / server work |
