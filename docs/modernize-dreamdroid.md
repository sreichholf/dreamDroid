...
| near-zero-java-video-activity | | open | Kotlin-port `VideoActivity` (VLC shell; overlay fragment stays Java). Keep dialogs / VideoOverlay / Leanback / RemoteViews / HttpURLConnection. |
