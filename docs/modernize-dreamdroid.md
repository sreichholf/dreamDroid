...
| tv-compose-hub-iv-e | | open | Phase 3.1c-iv-e: Compose TV hub movie location headers + lazy `loadMovieList` on select; text cards; stream file Intent edge unchanged. Leanback remains default behind debug flag. |
