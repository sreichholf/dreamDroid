...
| widgets-2-6e-glance | | open | Phase 2.6e: Glance hybrid Virtual Remote (`GlanceAppWidgetReceiver` + `AndroidRemoteViews` dense RCU); retire Java `VirtualRemoteWidgetProvider`. |
