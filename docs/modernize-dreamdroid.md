...
Wave 3 (operator choice): convert remaining **non-Compose phone UIs** to Compose + Kotlin, **one PR per screen**. Checklist in Appendix G. **Wave 3 phone screens complete on `main` through #206** (plus CI #204). Phone Phase 2.7 (Fragment shells → Kotlin Compose destinations) **2.7b–i merged** ([#306](https://github.com/sreichholf/dreamDroid/pull/306)–[#315](https://github.com/sreichholf/dreamDroid/pull/315)). **#316–#324 merged**. **This PR:** Kotlin-port `Timer`/`CheckProfile`/`BackupService`/`PiconSyncService`. **Next:** further near-zero Java / workarounds + Phase **3.1c-iv** / Phase 4–5.
...
- Phone NavHost Device Info through Hub are **Kotlin Compose destinations**; Phase **2.7b–i** **merged** ([#306](https://github.com/sreichholf/dreamDroid/pull/306)–[#315](https://github.com/sreichholf/dreamDroid/pull/315); decision [#304](https://github.com/sreichholf/dreamDroid/pull/304)). **#316–#324 merged**. **This PR:** Kotlin-port `Timer`/`CheckProfile`/`BackupService`/`PiconSyncService`. **Next:** further near-zero Java / workarounds + Phase **3.1c-iv** / Phase 4–5.
...
- **#316–#324 merged**. **This PR:** Kotlin-port `Timer`/`CheckProfile`/`BackupService`/`PiconSyncService`. Keep dialogs / VideoOverlay / Leanback / RemoteViews / HttpURLConnection Enigma2.
...
**Phase 2.7i merged** [#315](https://github.com/sreichholf/dreamDroid/pull/315). **#316–#324 merged**. **This PR:** Kotlin-port `Timer`/`CheckProfile`/`BackupService`/`PiconSyncService`. **Next:** further near-zero Java / workarounds + Phase **3.1c-iv** / Phase 4–5.
